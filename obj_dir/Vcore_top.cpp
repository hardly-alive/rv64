...
VL_INLINE_OPT void Vcore_top::_sequent__TOP__2(Vcore_top__Syms* __restrict vlSymsp) {
    ...
    vlTOPp->core_top__DOT__ex_reg_write = ((IData)(vlTOPp->rst_n) 
                                           & (IData)(vlTOPp->core_top__DOT__dec_reg_write));
