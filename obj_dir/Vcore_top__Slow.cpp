...
void Vcore_top::_initial__TOP__1(Vcore_top__Syms* __restrict vlSymsp) {
    ...
    vlTOPp->core_top__DOT__u_rom__DOT__mem[1U] = 0x13U;
    vlTOPp->core_top__DOT__u_rom__DOT__mem[2U] = 0x13U;
    vlTOPp->core_top__DOT__u_rom__DOT__mem[3U] = 0xa00113U;
    vlTOPp->core_top__DOT__u_rom__DOT__mem[4U] = 0x13U;
    vlTOPp->core_top__DOT__u_rom__DOT__mem[5U] = 0x13U;
    vlTOPp->core_top__DOT__u_rom__DOT__mem[6U] = 0x2081b3U;
}
                                          ...
                                          : ((4U & (IData)(vlTOPp->core_top__DOT__ex_alu_op))
                                              ? ((2U 
                                                 ...
                                                 ((1U 
                                                   & (IData)(vlTOPp->core_top__DOT__ex_alu_op))
                                                   ? 
                                                  VL_SHIFTRS_QQI(64,64,6, vlTOPp->core_top__DOT__ex_rs1_data, 
                                                                 (0x3fU 
                                              ...
                                              : ((2U 
                                                 ...
                                                 ((1U 
                                                   & (IData)(vlTOPp->core_top__DOT__ex_alu_op))
                                                   ? 
                                                  (VL_LTS_IQQ(1,64,64, vlTOPp->core_top__DOT__ex_rs1_data, vlTOPp->core_top__DOT__alu_operand_b)
                                                    ? 1ULL
                                                    : 0ULL)
                                                   : 
                                                  (vlTOPp->core_top__DOT__ex_rs1_data 
